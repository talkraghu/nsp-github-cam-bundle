# nsp-github-cam-bundle (detailed guide)

This file is the long-form companion to [`README.md`](./README.md). Use it for tables, troubleshooting, Postman notes, and CI specifics.

This repo **repacks** the **`nsp-ne-backup`** artifact bundle (vendored Go [`artifact-bundle-builder`](./builder/VENDOR.md)), then optionally **uploads** to NSP file service and **installs** via CAM REST, or **uninstalls** via CAM REST. Pilot scope: **`cam-lso-deployer-app`**, non-production lab only.
...
```bash
chmod +x scripts/uninstall-bundle.sh
